...
from lfas.models import CrisisResource, CrisisResult, CrisisType, DetectionResult, ProtectionLevel
...
class TestCrisisResource:
    ...
    def test_creation_with_defaults(self):
        resource = CrisisResource(
            name="Test Hotline", contact="1-800-TEST", description="Test description"
        )
...
class TestCrisisResult:
    ...
    def test_creation(self):
        resources = [
            CrisisResource(name="988 Lifeline", contact="988", description="Crisis support")
        ]
    ...
    def test_format_crisis_message(self):
        resources = [CrisisResource(name="Test Resource", contact="123", description="Test")]
